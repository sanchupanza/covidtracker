...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.example.library.R.styleable.BannerLayout);
        showIndicator = a.getBoolean(com.example.library.R.styleable.BannerLayout_showIndicator, true);
        autoPlayDuration = a.getInt(com.example.library.R.styleable.BannerLayout_interval, 4000);
        isAutoPlaying = a.getBoolean(com.example.library.R.styleable.BannerLayout_autoPlaying, true);
        itemSpace = a.getInt(com.example.library.R.styleable.BannerLayout_itemSpace, 20);
        centerScale = a.getFloat(com.example.library.R.styleable.BannerLayout_centerScale, 1.2f);
        moveSpeed = a.getFloat(com.example.library.R.styleable.BannerLayout_moveSpeed, 1.0f);
        ...
        int o = a.getInt(com.example.library.R.styleable.BannerLayout_orientation, 0);
        int orientation = 0;
        if (o == 0) {
